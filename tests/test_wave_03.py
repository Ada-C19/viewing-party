...
def test_friends_unique_movies_not_duplicated():
    ...
    # **************************************************************************************************
    assert amandas_data["watched"][0] not in friends_unique_movies
    assert amandas_data["watched"][1] not in friends_unique_movies
    assert amandas_data["watched"][2] not in friends_unique_movies
