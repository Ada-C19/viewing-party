    ...
    for friend in user_data["friends"]:
        ...
        for movie in friend["watched"]:
            ...
            if movie not in watched_movies:
                ...
                print("***********")
                # Check if movie is available in the user's subscription
                if friends_watched[0]["host"] in watched_movies:
                    # If so, then add movie to recommended list
...
#     reccommended_movies = []
#     user_watched = user_data["watched"]
#     genre = get_most_watched_genre(user_watched)
#     for movie in user_watched:
#         if movie["genre"] == genre and movie not in user_watched:

#             reccommended_movies.append(movie)
...
#     recommended_movies = []
#     [friend for friend in user_data["friends"]]:
#         for movie in friend["watched"]:
