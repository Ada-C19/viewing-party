...
def get_available_recs(user_data):
    ...
    #for loop to loop through friends_watched list of dictionaries and check it the user has already watched those movies by 
    #comparing against user_watched list of dictionaries and if the host of that movie is in the subscription list
